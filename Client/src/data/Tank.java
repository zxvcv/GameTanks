...
public class Tank extends Transformable implements GameObject, Shootable, CollisionManager, Sendable {
    ...
    public void dataUpdate() {
        //System.out.println("dataUpdate - data.Tank \t\tT: " + threadNum + " \tI: " + this.getIndex());
        //zmiana watosci po otrzymaniu danych od gracza
    }

    @Override
    public void collisionUpdate() {
        //System.out.println("collisionUpdate - data.Tank \t\tT: " + threadNum + " \tI: " + this.getIndex());
        /*
        ...
        for(data.Drawable o : collisions){
            if(o instanceof data.Block || o instanceof data.Tank)
    ...
    public void afterUpdate() {
        //System.out.println("afterUpdate - data.Tank \t\tT: " + threadNum + " \tI: " + this.getIndex());
        //---
    }
