...
public class Game {
    ...
    class ServerDataTransmitterIn implements Runnable {
        ...
        public ServerDataTransmitterIn(Player player, Socket socket) throws IOException {
            this.player = player;
            this.socket = socket;
            inputStream = new ObjectInputStream(socket.getInputStream());
        }
    ...
    class ServerDataTransmitterOut implements Runnable {
        ...
        public ServerDataTransmitterOut(Player player, Socket socket) throws IOException {
            this.player = player;
            this.socket = socket;
            outputStream = new ObjectOutputStream(socket.getOutputStream());
        }
